            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-500">
                  {userProjects.length} projet(s) trouvé(s)
                </p>
              </div>
            </div>
          </div>
            ...
            {userProjects.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 text-lg">
                  Cet utilisateur n'a aucun projet
                </p>
                <p className="text-sm text-gray-400 mt-1">
                  Les projets apparaîtront ici une fois assignés
                </p>
              </div>
            )}
          </div>
                    ...
                    >
                      <td className="px-8 py-6">
                        <div className="flex items-center space-x-4">
                          <div className="relative">
                            <div
                              className={`h-12 w-12 rounded-2xl bg-gradient-to-br ${getRoleColor(
                                user.userRole
                      ...
                      <td className="px-8 py-6">
                        <div
                          className={`inline-flex items-center space-x-2 px-4 py-2 rounded-2xl bg-gradient-to-r ${getRoleColor(
                            user.userRole
                      ...
                      <td className="px-8 py-6">
                        <span className="text-gray-900 font-medium">
                          {user.company || "Non définie"}
                        </span>
                      </td>
                      <td className="px-8 py-6">
                        <div
                          className={`inline-flex items-center space-x-2 px-4 py-2 text-sm font-bold rounded-2xl shadow-lg ${
                            user.isActivated
                      ...
                      <td className="px-8 py-6">
                        <div className="flex items-center space-x-3">
                          ...
                          <button
                            onClick={() =>
                              toggleUserStatus(user._id, user.isActivated)
                            }
